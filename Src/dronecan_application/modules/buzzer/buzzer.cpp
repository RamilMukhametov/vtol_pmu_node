...
void Buzzer::update_params() {
    error_melody = (Melody)paramsGetIntegerValue(IntParamsIndexes::PARAM_BUZZER_ERROR_MELODY);
    arm_melody = (Melody)paramsGetIntegerValue(IntParamsIndexes::PARAM_BUZZER_ARM_MELODY);
